...
2. In the search field type "WP Body Mass Widget" and click Search Plugins.
...
5. Now, go to the Widgets page of the Appearance section and configure the WP Body Mass Widget.
...
4. Now, go to the Widgets page of the Appearance section and configure the WP Body Mass Widget.
...
= 1.0 =
* Initial release by Michelle Salabert.
